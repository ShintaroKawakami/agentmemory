...
# AI モデル選定指標（Codex 5.6 / GLM 5.3 / Kimi K2.7・K3）
...
**三役の呼称（2026-08-31）**: 監督=Claude / Codex 5.6 / Cursor（PM クライアント）／参謀=Kimi K3／職人メイン=GLM 5.3 max・Gemini 3.7 Flash Medium+High・Codex 5.6 Luna/Terra。Codex Sol は難所限定、Spark は overflow。OpenCode Go は予備。正本: `agents.yaml` の `role_titles` と `worker_delegation.lane_policy`。
...
| 小〜中の明確な実装 | **Codex 5.6 Luna / Terra** | 役割キーで解決。通常は Luna、標準は Terra |
